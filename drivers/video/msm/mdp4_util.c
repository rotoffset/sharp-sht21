...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00007 */ /* CUST_ID_00008 */ /* CUST_ID_00009 */ /* CUST_ID_00011 */ /* CUST_ID_00012 */ /* CUST_ID_00013 */ /* CUST_ID_00022 */ /* CUST_ID_00029 */ /* CUST_ID_00044 */
int vg_dither_set_flg = 0;
int vg_hist_lut_set_flg = 0;
int vg_qseed_set_flg = 0;
int vg_csc_set_flg = 0;

struct msmfb_pipe_hist_lut_data pipe_hist_lut_data;
static unsigned char pipe_hist_lut_tbl[MDP_PIPE_HIST_LUT_SIZE] = {
...
int hist_lut_enable = 0;

struct msmfb_pipe_qseed_data pipe_qseed_data;
static int8_t sharp_strength = 0;

struct msmfb_dma_convert_data dma_convert_data;
struct mdp4_convert_matrix {
uint32 convert_mv[9];
uint32 convert_pre_bv[3];
uint32 convert_post_bv[3];
uint32 convert_pre_lv[6];
uint32 convert_post_lv[6];
} dma_convert_matrix =
{
	{
...
int convert_enable = 0;
int convert_set_flag = 0;

struct msmfb_dma_pcc_data dma_pcc_data;
uint32 pcc_datatbl_red[MDP_PCC_COLOR_SIZE] =
{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
uint32 pcc_datatbl_green[MDP_PCC_COLOR_SIZE] =
{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
uint32 pcc_datatbl_blue[MDP_PCC_COLOR_SIZE] =
{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
int pcc_enable = 0;
int pcc_set_flag = 0;

struct msmfb_dma_argc_lut_data dma_argc_data;
struct mdp4_argc_matrix {
	struct pgc_ctrl color0[MDP_ARGC_STAGE_SIZE];
	struct pgc_ctrl color1[MDP_ARGC_STAGE_SIZE];
	struct pgc_ctrl color2[MDP_ARGC_STAGE_SIZE];
} dma_argc_matrix =
{
	{
		{ 0x0001, 0x0010, 0x0001, 0x0010 },
		{ 0x0001, 0x0020, 0x0001, 0x0020 },
		{ 0x0001, 0x0030, 0x0001, 0x0030 },
		{ 0x0001, 0x0040, 0x0001, 0x0040 },

		{ 0x0001, 0x0050, 0x0001, 0x0050 },
		{ 0x0001, 0x0060, 0x0001, 0x0060 },
		{ 0x0001, 0x0070, 0x0001, 0x0070 },
		{ 0x0001, 0x0080, 0x0001, 0x0080 },

		{ 0x0001, 0x0090, 0x0001, 0x0090 },
		{ 0x0001, 0x00a0, 0x0001, 0x00a0 },
		{ 0x0001, 0x00b0, 0x0001, 0x00b0 },
		{ 0x0001, 0x00c0, 0x0001, 0x00c0 },
 
		{ 0x0001, 0x00d0, 0x0001, 0x00d0 },
		{ 0x0001, 0x00e0, 0x0001, 0x00e0 },
		{ 0x0001, 0x00f0, 0x0001, 0x00f0 },
	...
	{
		{ 0x0001, 0x0100, 0x0001, 0x0010 },
		{ 0x0001, 0x0120, 0x0001, 0x0020 },
		{ 0x0001, 0x0140, 0x0001, 0x0030 },
		{ 0x0001, 0x0160, 0x0001, 0x0040 },

		{ 0x0001, 0x0180, 0x0001, 0x0050 },
		{ 0x0001, 0x01a0, 0x0001, 0x0060 },
		{ 0x0001, 0x01c0, 0x0001, 0x0070 },
		{ 0x0001, 0x01e0, 0x0001, 0x0080 },

		{ 0x0001, 0x0200, 0x0001, 0x0090 },
		{ 0x0001, 0x0220, 0x0001, 0x00a0 },
		{ 0x0001, 0x0240, 0x0001, 0x00b0 },
		{ 0x0001, 0x0260, 0x0001, 0x00c0 },
 
		{ 0x0001, 0x0280, 0x0001, 0x00d0 },
		{ 0x0001, 0x02a0, 0x0001, 0x00e0 },
		{ 0x0001, 0x02c0, 0x0001, 0x00f0 },
		{ 0x0001, 0x02e0, 0x0001, 0x0100 }
	}
};
int argc_enable = 1;
struct msmfb_dma_argc_lut_read_data dma_argc_read_data;
...
irqreturn_t mdp4_isr(int irq, void *ptr)
{
	...
	int i, ret;
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00062 */
	uint32 rdata;
#endif	/* CONFIG_SHLCDC_BOARD */
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00062 */ /* CUST_ID_00078 */
		panel = mdp4_overlay_panel_list();
		if (panel & MDP4_PANEL_DSI_VIDEO) {
			mdp4_dma_pcc_setup();
			mdp4_dma_argc_lut_setup();
		} else if (panel & MDP4_PANEL_DSI_CMD) {
			rdata = inpdw(MDP_BASE + 0x90000);
			rdata &= ~0x30000000;
			outpdw(MDP_BASE + 0x90000, rdata);
		}
#endif	/* CONFIG_SHLCDC_BOARD */
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00009 */ /* CUST_ID_00010 */
...
void mdp4_vg_csc_mv_setup(int vp_num)
{
	...
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
	for (i = 0; i < 9; i++) {
		outpdw(off, vg_csc_matrix.csc_mv[i]);
		off++;
	}
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_OFF, FALSE);
}
...
void mdp4_vg_csc_pre_bv_setup(int vp_num)
{
	...
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
	for (i = 0; i < 3; i++) {
		outpdw(off, vg_csc_matrix.csc_pre_bv[i]);
		off++;
	}
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_OFF, FALSE);
}
...
void mdp4_vg_csc_post_bv_setup(int vp_num)
{
	...
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
	for (i = 0; i < 3; i++) {
		outpdw(off, vg_csc_matrix.csc_post_bv[i]);
		off++;
	}
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_OFF, FALSE);
}
...
void mdp4_vg_csc_pre_lv_setup(int vp_num)
{
	...
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
	for (i = 0; i < 6; i++) {
		outpdw(off, vg_csc_matrix.csc_pre_lv[i]);
		off++;
	}
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_OFF, FALSE);
}
...
void mdp4_vg_csc_post_lv_setup(int vp_num)
{
	...
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
	for (i = 0; i < 6; i++) {
		outpdw(off, vg_csc_matrix.csc_post_lv[i]);
		off++;
	}
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_OFF, FALSE);
}
...
{
	if (vp_num >= OVERLAY_PIPE_VG1)
		vp_num = vp_num - OVERLAY_PIPE_VG1;
...
{
	if (p->enable > 1) {
		pr_err("%s - invalid enable = %d", __func__, p->enable);
		return;
	}

	if ((p->csc_mv == NULL) || (p->csc_pre_bv == NULL) || (p->csc_post_bv == NULL) || (p->csc_pre_lv == NULL) || (p->csc_post_lv == NULL)) {
		pr_err("%s - invalid table", __func__);
		return;
	}

	if (p->enable) {
		memcpy(vg_csc_matrix.csc_mv, p->csc_mv, sizeof(p->csc_mv));
		memcpy(vg_csc_matrix.csc_pre_bv, p->csc_pre_bv,
			sizeof(p->csc_pre_bv));
		memcpy(vg_csc_matrix.csc_post_bv, p->csc_post_bv,
			sizeof(p->csc_post_bv));
		memcpy(vg_csc_matrix.csc_pre_lv, p->csc_pre_lv,
			sizeof(p->csc_pre_lv));
		memcpy(vg_csc_matrix.csc_post_lv, p->csc_post_lv,
				sizeof(p->csc_post_lv));
	} else {
		memcpy(vg_csc_matrix.csc_mv, csc_matrix[0].csc_mv, sizeof(vg_csc_matrix.csc_mv));
		memcpy(vg_csc_matrix.csc_pre_bv, csc_matrix[0].csc_pre_bv, sizeof(vg_csc_matrix.csc_pre_bv));
		memcpy(vg_csc_matrix.csc_post_bv, csc_matrix[0].csc_post_bv, sizeof(vg_csc_matrix.csc_post_bv));
		memcpy(vg_csc_matrix.csc_pre_lv, csc_matrix[0].csc_pre_lv, sizeof(vg_csc_matrix.csc_pre_lv));
		memcpy(vg_csc_matrix.csc_post_lv, csc_matrix[0].csc_post_lv, sizeof(vg_csc_matrix.csc_post_lv));
	}
...
{
	uint32 off, data;
	uint32 r_bit = 0x01;	/* component 2, R_Cr */
	uint32 b_bit = 0x01;	/* component 1, B_Cb */
	uint32 g_bit = 0x01;	/* component 0, G_lumz */

	off = (vp_num - OVERLAY_PIPE_VG1) * 0x10000;

	/* MDP cmd block enable */
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);

	data = r_bit << 4 | b_bit << 2 | g_bit;
	outpdw(MDP_BASE + 0x20068 + off, data);

	data = inpdw(MDP_BASE + 0x20058 + off);
	data |= 0x8000;
	outpdw(MDP_BASE + 0x20058 + off, data);
...
int mdp4_vg_hist_lut_setup(int vp_num)
{
	...
	if (hist_lut_enable) {
		for (i = 0; i < MDP_PIPE_HIST_LUT_SIZE; i++) {
			outpdw(MDP_BASE + 0x23400 + off + (0x400 * mdp_pipe_lut_i) + i*4, pipe_hist_lut_tbl[i]);
		}

		outpdw(MDP_BASE + 0x20064 + off, mdp_pipe_lut_i);

		data = inpdw(MDP_BASE + 0x20058 + off);
		data |= 0x20000;
		outpdw(MDP_BASE + 0x20058 + off, data);

		mdp_pipe_lut_i = (mdp_pipe_lut_i + 1)%2;
...
int mdp4_vg_hist_lut_update(struct msmfb_pipe_hist_lut_data *p)
{
	...
	hist_lut_enable = p->enable;

	for (i = 0; i < MDP_PIPE_HIST_LUT_SIZE; i++) {
		ret = copy_from_user(&pipe_hist_lut_tbl[i], p->color0++, sizeof(uint8));
		if (ret) {
			return -EFAULT;
		}
	}
...
void mdp4_vg_qseed_setup(void)
{
	...
	outpdw(MDP_BASE + 0x28200, mdp4_ss_table_value(sharp_strength, 0));
	outpdw(MDP_BASE + 0x28204, mdp4_ss_table_value(sharp_strength, 1));
...
int mdp4_vg_qseed_update(struct msmfb_pipe_qseed_data *p)
{
	...
	if ((p->sharp_strength < -128) || (p->sharp_strength > 127))
		return -EINVAL;
...
void mdp4_dma_picture_adjust_setup(void)
{
	...
	mdp_dma_abl_lut_set_dummy();
	mdp_dma_abl_lut_combine();
	mdp_dma_abl_lut_hw_setup(MDP_ABL_LUT_SIZE);
	mdp_dma_abl_lut_hw_enable();
...
void mdp4_dma_picture_adjust_setup_command_mode(void)
{
	...
	mdp_dma_abl_lut_combine();
	mdp_dma_abl_lut_hw_setup(MDP_ABL_LUT_SIZE);
	mdp_dma_abl_lut_hw_enable_command_mode();
...
void mdp4_dma_convert_setup(void)
{
	...
	if (convert_enable) {
		...
		for (i = 0; i < MDP_MV1_SIZE; i++)
			writel(dma_convert_matrix.convert_mv[i], MDP_DMAP_CSC_MV1n(i));
		for (i = 0; i < MDP_PRE_BV1_SIZE; i++)
			writel(dma_convert_matrix.convert_pre_bv[i], MDP_DMAP_CSC_PRE_BV1n(i));
		for (i = 0; i < MDP_POST_BV1_SIZE; i++)
			writel(dma_convert_matrix.convert_post_bv[i], MDP_DMAP_CSC_POST_BV1n(i));
		for (i = 0; i < MDP_PRE_LV1_SIZE; i++)
			writel(dma_convert_matrix.convert_pre_lv[i], MDP_DMAP_CSC_PRE_LV1n(i));
		for (i = 0; i < MDP_POST_LV1_SIZE; i++)
			writel(dma_convert_matrix.convert_post_lv[i], MDP_DMAP_CSC_POST_LV1n(i));

		data = inpdw(MDP_BASE + 0x90070);
		data |= 0x08;
		outpdw(MDP_BASE + 0x90070, data);
...
int mdp4_dma_convert_update(struct msmfb_dma_convert_data *p)
{
	...
	if ((p->mv1 == NULL) || (p->pre_bv1 == NULL) || (p->post_bv1 == NULL) || (p->pre_lv1 == NULL) || (p->post_lv1 == NULL)) {
		return -EINVAL;
	}

	convert_enable = p->enable;

	memcpy(dma_convert_matrix.convert_mv, p->mv1, sizeof(p->mv1));
	memcpy(dma_convert_matrix.convert_pre_bv, p->pre_bv1, sizeof(p->pre_bv1));
	memcpy(dma_convert_matrix.convert_post_bv, p->post_bv1, sizeof(p->post_bv1));
	memcpy(dma_convert_matrix.convert_pre_lv, p->pre_lv1, sizeof(p->pre_lv1));
	memcpy(dma_convert_matrix.convert_post_lv, p->post_lv1, sizeof(p->post_lv1));
...
void mdp4_dma_pcc_setup(void)
{
	...
	if (pcc_enable) {
		pcc_en_state = inpdw(MDP_BASE + 0x90000);
		pcc_en_state &= 0x20000000;

		if( !pcc_en_state ){
			for (i = 0; i < MDP_PCC_COLOR_SIZE; i++) {
				outpdw(MDP_BASE + 0x9A000 + i*4, pcc_datatbl_red[i]);
				outpdw(MDP_BASE + 0x9A030 + i*4, pcc_datatbl_green[i]);
				outpdw(MDP_BASE + 0x9A060 + i*4, pcc_datatbl_blue[i]);

				outpdw(MDP_BASE + 0x9A100 + i*4, pcc_datatbl_red[i]);
				outpdw(MDP_BASE + 0x9A130 + i*4, pcc_datatbl_green[i]);
				outpdw(MDP_BASE + 0x9A160 + i*4, pcc_datatbl_blue[i]);
			}

			data = inpdw(MDP_BASE + 0x90000);
			data |= 0x20000000;
			outpdw(MDP_BASE + 0x90000, data);
			...
			pcc_sel_state = inpdw(MDP_BASE + 0x90070);
			pcc_sel_state &= 0x2000;
...
int mdp4_dma_pcc_update(struct msmfb_dma_pcc_data *p)
{
	...
	for (i = 0; i < MDP_PCC_COLOR_SIZE; i++) {
		if (copy_from_user(&pcc_datatbl_red[i], p->red++, sizeof(uint32)) ||
			copy_from_user(&pcc_datatbl_green[i], p->green++, sizeof(uint32)) ||
			copy_from_user(&pcc_datatbl_blue[i], p->blue++, sizeof(uint32)) )
			return -EFAULT;
	}
...
void mdp4_dma_argc_lut_setup(void)
{
	...
	if (argc_enable) {
		for (i = 0; i < MDP_ARGC_STAGE_SIZE; i++) {
			data = dma_argc_matrix.color1[i].enable;
			data = ((data << 16) | dma_argc_matrix.color1[i].start);
			outpdw(MDP_BASE + 0x98800 + i*4, data);
			data = dma_argc_matrix.color1[i].offset;
			data = ((data << 16) | dma_argc_matrix.color1[i].gain);
			outpdw(MDP_BASE + 0x98880 + i*4, data);
		}

		for (i = 0; i < MDP_ARGC_STAGE_SIZE; i++) {
			data = dma_argc_matrix.color2[i].enable;
			data = ((data << 16) | dma_argc_matrix.color2[i].start);
			outpdw(MDP_BASE + 0x98900 + i*4, data);
			data = dma_argc_matrix.color2[i].offset;
			data = ((data << 16) | dma_argc_matrix.color2[i].gain);
			outpdw(MDP_BASE + 0x98980 + i*4, data);
		}

		for (i = 0; i < MDP_ARGC_STAGE_SIZE; i++) {
			data = dma_argc_matrix.color0[i].enable;
			data = ((data << 16) | dma_argc_matrix.color0[i].start);
			outpdw(MDP_BASE + 0x98A00 + i*4, data);
			data = dma_argc_matrix.color0[i].offset;
			data = ((data << 16) | dma_argc_matrix.color0[i].gain);
			outpdw(MDP_BASE + 0x98A80 + i*4, data);
		}
...
int mdp4_dma_argc_lut_update(struct msmfb_dma_argc_lut_data *p)
{
	...
	if ((p->color0 == NULL) || (p->color1 == NULL) || (p->color2 == NULL))
		return -EINVAL;

	argc_enable = p->enable;

	memcpy(dma_argc_matrix.color0, p->color0, sizeof(dma_argc_matrix.color0));
	memcpy(dma_argc_matrix.color1, p->color1, sizeof(dma_argc_matrix.color1));
	memcpy(dma_argc_matrix.color2, p->color2, sizeof(dma_argc_matrix.color2));
...
int mdp4_dma_argc_lut_get(struct msmfb_dma_argc_lut_read_data *p)
{
	...
	if ((p->ckind < 0) || (p->ckind > 2))
		return -EINVAL;

	if ((p->stage < 0) || (p->stage > 15))
		return -EINVAL;
	...
	addr = 0x98800 + (p->ckind * 0x100) + (p->stage * 4);
	data = inpdw(MDP_BASE + addr);
	p->color.enable = (uint16)(data >> 16);
	p->color.start = (uint16)data;

	addr = addr + 0x80;
	data = inpdw(MDP_BASE + addr);
	p->color.offset = (uint16)(data >> 16);
	p->color.gain = (uint16)data;
...
int mdp4_dma_argc_lut_read_diagarea(void)
{
	...
	if( p == NULL) {
		...
		for (i = 0; i < MDP_ARGC_STAGE_SIZE; i++) {
			memcpy(&dma_argc_matrix.color0[i], &shdisp_boot_ctx.argc_lut_gamma.red[i], sizeof(struct pgc_ctrl));
			memcpy(&dma_argc_matrix.color1[i], &shdisp_boot_ctx.argc_lut_gamma.green[i], sizeof(struct pgc_ctrl));
			memcpy(&dma_argc_matrix.color2[i], &shdisp_boot_ctx.argc_lut_gamma.blue[i], sizeof(struct pgc_ctrl));
		}
	}
