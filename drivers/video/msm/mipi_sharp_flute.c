...
static char mipi_sharp_cmd_panelctl1[9] = {0xB4, 0x00,0x02,0x03,0x04,0x05,0x08,0x00,0x06};
static char mipi_sharp_cmd_company[2] = {0xB8, 0x81};
static char mipi_sharp_cmd_madctl[2] = {0x36, 0x00};
static char mipi_sharp_cmd_dispctl_for_video[8] = {0xF2, 0x19,0x00,0x0A,0x16,0x1E,0x1C,0x08};
static char mipi_sharp_cmd_dispctl_for_cmd[8] = {0xF2, 0x10,0x00,0x0A,0x16,0x1E,0x1C,0x08};
...
static char mipi_sharp_cmd_pwrctl2[7] = {0xF5, 0x69,0x69,0x48,0x48,0x36,0x08};
static char mipi_sharp_cmd_srcctl[7] = {0xF6, 0x03,0x03,0x8A,0x00,0x01,0x16};
...
static char mipi_sharp_cmd_pgammactl[49] = {0xFA, 
    0x01,0x03,0x00,0x09,0x00,0x05,0x00,0x08,0x06,0x0C,0x13,0x14,
    0x18,0x1E,0x10,0x05,0x01,0x03,0x00,0x09,0x00,0x05,0x00,0x08,
    0x06,0x0C,0x13,0x14,0x18,0x1E,0x10,0x05,0x01,0x03,0x00,0x09,
    0x00,0x05,0x00,0x08,0x06,0x0C,0x13,0x14,0x18,0x1E,0x10,0x05};
static char mipi_sharp_cmd_ngammactl[49] = {0xFB, 
    0x01,0x0A,0x09,0x14,0x05,0x0A,0x05,0x10,0x11,0x15,0x1A,0x1A,
    0x1B,0x20,0x12,0x05,0x01,0x0A,0x09,0x14,0x05,0x0A,0x05,0x10,
    0x11,0x15,0x1A,0x1A,0x1B,0x20,0x12,0x05,0x01,0x0A,0x09,0x14,
    0x05,0x0A,0x05,0x10,0x15,0x11,0x1A,0x1A,0x1B,0x12,0x20,0x05};
static char mipi_sharp_cmd_logictest[4] = {0xFE, 0x00,0x0B,0x00};
static char mipi_sharp_cmd_leelctl[2] = {0xB9, 0x07};
static char mipi_sharp_cmd_tescan[3] = {0x44, 0x01,0x2C};
static char mipi_sharp_cmd_teon[2] = {0x35, 0x00};
...
static struct dsi_cmd_desc mipi_sharp_cmds_panelctl1_for_cmd[] = {
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_panelctl1), mipi_sharp_cmd_panelctl1},
    {DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_company), mipi_sharp_cmd_company},
    {DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_madctl), mipi_sharp_cmd_madctl}
};
...
static struct dsi_cmd_desc mipi_sharp_cmds_dispctl_for_cmd[] = {
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_dispctl_for_cmd), mipi_sharp_cmd_dispctl_for_cmd}
};
...
static struct dsi_cmd_desc mipi_sharp_cmds_leelctl[] = {
    {DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_leelctl), mipi_sharp_cmd_leelctl},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_tescan), mipi_sharp_cmd_tescan},
    {DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_teon), mipi_sharp_cmd_teon}
};
...
static struct dsi_cmd_desc mipi_sharp_cmds_disp_on_for_cmd[] = {
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_passwd1_l2_unmask), mipi_sharp_cmd_passwd1_l2_unmask},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_batctl), mipi_sharp_cmd_batctl},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_passwd1_l2_mask), mipi_sharp_cmd_passwd1_l2_mask},
    {DTYPE_DCS_WRITE, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_disp_on), mipi_sharp_cmd_disp_on}
...
static struct dsi_cmd_desc mipi_sharp_cmds_disp_off_for_cmd[] = {
    {DTYPE_DCS_WRITE, 1, 0, 0, 0, sizeof(mipi_sharp_cmd_disp_off), mipi_sharp_cmd_disp_off}
};
...
static int mipi_sharp_cmd_lcd_on(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi)
{
    ...
    if (mipi->mode == DSI_VIDEO_MODE) {
        ...
        mipi_dsi_cmds_tx(&sharp_tx_buf, mipi_sharp_cmds_panelctl1_for_cmd,
                         ARRAY_SIZE(mipi_sharp_cmds_panelctl1_for_cmd));
        mipi_dsi_cmds_tx(&sharp_tx_buf, mipi_sharp_cmds_dispctl_for_cmd,
                         ARRAY_SIZE(mipi_sharp_cmds_dispctl_for_cmd));
    }
    ...
    if (mipi->mode == DSI_CMD_MODE) {
        mipi_dsi_cmds_tx(&sharp_tx_buf, mipi_sharp_cmds_leelctl,
                         ARRAY_SIZE(mipi_sharp_cmds_leelctl));
    }
    mipi_dsi_cmds_tx(&sharp_tx_buf, mipi_sharp_cmds_passwd1_l3_mask,
                     ARRAY_SIZE(mipi_sharp_cmds_passwd1_l3_mask));
...
static int mipi_sharp_cmd_lcd_display_on(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi)
{
    ...
    if (mipi->mode == DSI_VIDEO_MODE) {
        ...
        mipi_dsi_cmds_tx(&sharp_tx_buf, mipi_sharp_cmds_disp_on_for_cmd,
                         ARRAY_SIZE(mipi_sharp_cmds_disp_on_for_cmd));
    }
	return 0;
}
...
static int mipi_sharp_cmd_lcd_display_off(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi)
{
    ...
    if (mipi->mode == DSI_VIDEO_MODE) {
        ...
        mipi_dsi_cmds_tx(&sharp_tx_buf, mipi_sharp_cmds_disp_off_for_cmd,
                         ARRAY_SIZE(mipi_sharp_cmds_disp_off_for_cmd));
    }
    mipi_sharp_delay_us(1000);
...
#if 0
static int mipi_sharp_flute_lcd_deep_standby(struct msm_fb_data_type *mfd)
{
	struct mipi_panel_info *mipi;
	int ret = 0;
	...
	if (mipi->mode == DSI_VIDEO_MODE) {
		mutex_lock(&mfd->dma->ov_mutex);
		ret = mipi_sharp_cmd_lcd_deep_stanby(mfd, mipi);
		mutex_unlock(&mfd->dma->ov_mutex);
	}
