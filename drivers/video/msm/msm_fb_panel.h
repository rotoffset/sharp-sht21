...
struct msm_panel_info {
	...
	__u32 is_3d_panel;
	__u32 frame_rate;
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00081 */
	__u32 height_in_mm;
	__u32 width_in_mm;
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00041 */ /* CUST_ID_00079 */ /* CUST_ID_00090 */ /* CUST_ID_00094 */ /* CUST_ID_00119 */ /* CUST_ID_00142 */
	int (*start_display) (struct msm_fb_data_type *);
	int (*stop_display) (struct msm_fb_data_type *);
	int (*cabc_init) (struct msm_fb_data_type *, struct mipi_panel_info *);
	int (*cabc_indoor_on) (struct msm_fb_data_type *, struct mipi_panel_info *);
	int (*cabc_outdoor_on) (struct msm_fb_data_type *, struct mipi_panel_info *, int);
	int (*cabc_off) (struct msm_fb_data_type *, struct mipi_panel_info *, int, int);
	int (*cabc_outdoor_move) (struct msm_fb_data_type *, struct mipi_panel_info *, int);
	int (*cabc_ctrl) (struct platform_device *pde);
	int (*set_lpf) (struct msm_fb_data_type *, struct mipi_panel_info *, unsigned char *);
#endif /* CONFIG_SHLCDC_BOARD */
