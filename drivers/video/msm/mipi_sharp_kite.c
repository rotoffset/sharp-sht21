...
#if !defined(CONFIG_MACH_TOR) && !defined(CONFIG_MACH_DECKARD_AS70) && !defined(CONFIG_MACH_LYNX_DL10)
...
#if defined(CONFIG_SHDISP_USE_CABC) && !defined(CONFIG_MACH_TOR) && !defined(CONFIG_MACH_DECKARD_AS70) && !defined(CONFIG_MACH_LYNX_DL10)
static int mipi_sharp_cabc_lcd_backlight_on(void)
{
	int rc;
