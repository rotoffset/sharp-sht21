...
#define SHDISP_HW_REV_ES0           0
#define SHDISP_HW_REV_ES1           5
#define SHDISP_HW_REV_ES15          1
#define SHDISP_HW_REV_PP1           6
#define SHDISP_HW_REV_PP15          3
#define SHDISP_HW_REV_PP2           7
#define SHDISP_HW_REV_PP2_B         2
