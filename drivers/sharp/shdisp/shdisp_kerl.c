...
#if 0
static int shdisp_panel_API_check_upper_unit(void);
static int shdisp_panel_API_check_flicker_param(unsigned short alpha_in, unsigned short *alpha_out);
#endif
