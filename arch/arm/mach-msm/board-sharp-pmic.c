...
#if defined(CONFIG_PM_GPIO_KYPD_SENS_TYPE1)
	PM8XXX_GPIO_INPUT_FUNC(1, PM_GPIO_PULL_UP_1P5_30, PM_GPIO_FUNC_1),	/* KYPD_SNS1 UP */
	PM8XXX_GPIO_INPUT_FUNC(2, PM_GPIO_PULL_UP_1P5_30, PM_GPIO_FUNC_1),	/* KYPD_SNS2 UP */
	PM8XXX_GPIO_INPUT_FUNC(3, PM_GPIO_PULL_UP_1P5_30, PM_GPIO_FUNC_1),	/* KYPD_SNS3 UP */
	PM8XXX_GPIO_INPUT_FUNC(4, PM_GPIO_PULL_UP_1P5_30, PM_GPIO_FUNC_1),	/* KYPD_SNS4 UP */
	PM8XXX_GPIO_INPUT_FUNC(5, PM_GPIO_PULL_UP_1P5_30, PM_GPIO_FUNC_1),	/* KYPD_SNS5 UP */
	PM8XXX_GPIO_INPUT_FUNC(6, PM_GPIO_PULL_UP_1P5_30, PM_GPIO_FUNC_1),	/* KYPD_SNS6 UP */
	PM8XXX_GPIO_INPUT_FUNC(7, PM_GPIO_PULL_UP_1P5_30, PM_GPIO_FUNC_1),	/* KYPD_SNS7 UP */
	PM8XXX_GPIO_INPUT_FUNC(8, PM_GPIO_PULL_UP_1P5_30, PM_GPIO_FUNC_1),	/* KYPD_SNS8 UP */
	PM8XXX_GPIO_OUTPUT_FUNC(9, 0, PM_GPIO_FUNC_1),				/* KYPD_DRV1 */
	PM8XXX_GPIO_INPUT(10, PM_GPIO_PULL_DN),	
	PM8XXX_GPIO_INPUT(11, PM_GPIO_PULL_DN),	
	PM8XXX_GPIO_INPUT(12, PM_GPIO_PULL_DN),	
#else	/* CONFIG_PM_GPIO_KYPD_SENS_TYPE1 */
...
#if defined(CONFIG_PM_GPIO_KEY_DISABLE_TYPE1)
	PM8XXX_GPIO_INPUT_DISABLE(5),				/* Disable unused */
	PM8XXX_GPIO_INPUT_DISABLE(6),				/* Disable unused */
#else
	PM8XXX_GPIO_INPUT_FUNC(5, PM_GPIO_PULL_UP_1P5_30, PM_GPIO_FUNC_1),	/* KYPD_SNS5 UP */
	PM8XXX_GPIO_INPUT_FUNC(6, PM_GPIO_PULL_UP_1P5_30, PM_GPIO_FUNC_1),	/* KYPD_SNS6 DOWN */
#endif
#if defined(CONFIG_PM_GPIO_KYPD_SENS7)
	PM8XXX_GPIO_INPUT(7, PM_GPIO_PULL_UP_1P5_30),	/* KYPD_SENS7 */
#else
...
#endif	/* CONFIG_PM_GPIO_KYPD_SENS_TYPE1 */
#if defined(CONFIG_PM_GPIO_NFC_INTU_NP)
	PM8XXX_GPIO_INPUT(13, PM_GPIO_PULL_NO),		/* NFC_INTU */
#else
#if defined(CONFIG_PM_GPIO_NFC_INTU_MNB)
	PM8XXX_GPIO_INPUT_DISABLE(13),				/* NFC_INTU */
#else
	PM8XXX_GPIO_INPUT(13, PM_GPIO_PULL_UP_30),	/* NFC_INTU */
#endif
#endif
#if defined(CONFIG_PM_GPIO_NFC_HSEL_MNB)
	PM8XXX_GPIO_INPUT_DISABLE(14),				/* NFC_HSEL */
#else
	PM8XXX_GPIO_OUTPUT(14, 0),					/* NFC_HSEL */
#endif
...
#if defined(CONFIG_PM_GPIO_RCVPD_N)
	PM8XXX_GPIO_OUTPUT(21, 0),					/* RCVPD_N */
#else
...
#else
	PM8XXX_GPIO_INPUT(22, PM_GPIO_PULL_DN),		/* Disable unused */
#endif
...
#endif
#if defined(CONFIG_PM_GPIO_PWM_OUT)
	PM8XXX_GPIO_OUTPUT_FUNC(24, 0, PM_GPIO_FUNC_2),	/* PWM_OUT */
#else
	PM8XXX_GPIO_INPUT_DISABLE(24),				/* Disable unused */
#endif
#if defined(CONFIG_PM_GPIO_MHL_REG12_EN)
	PM8XXX_GPIO_OUTPUT(25, 0),					/* MHL_REG12_EN */
#else
	PM8XXX_GPIO_INPUT_DISABLE(25),				/* Disable unused */
#endif
	PM8XXX_GPIO_INPUT(26, PM_GPIO_PULL_NO),		/* SD_DET_N */
	PM8XXX_GPIO_INPUT_DISABLE(28),				/* Disable unused */
#if defined(CONFIG_PM_GPIO_SPPD_N)
	PM8XXX_GPIO_OUTPUT(31, 0),					/* SPPD_N */
#else
...
#if defined(CONFIG_PM_GPIO_FAN_EN)
	PM8XXX_GPIO_OUTPUT(35, 0),					/* FAN_EN */
#else
...
#if defined(CONFIG_PM_GPIO_FAN_VSEL)
	PM8XXX_GPIO_OUTPUT(44, 0),					/* FAN_VSEL */
#else
...
#if defined(CONFIG_PM_MPP_SCAM_STBY_N)
	PM8XXX_MPP_INIT(9, D_OUTPUT, PM8921_MPP_DIG_LEVEL_S4,   DOUT_CTRL_LOW),		/* SCAM_STBY_N */
#else
	PM8XXX_MPP_INIT(9, A_OUTPUT, PM8XXX_MPP_AOUT_LVL_1V25,  AOUT_CTRL_DISABLE),	/* Unused */
#endif
	PM8XXX_MPP_INIT(10,A_OUTPUT, PM8XXX_MPP_AOUT_LVL_1V25,  AOUT_CTRL_DISABLE),	/* CHG_CUR_OUT */
...
#ifdef CONFIG_BATTERY_SH
#if defined(CONFIG_PM_HIGH_CAPA_BATTERY_TYPE1)
	#define MAX_VOLTAGE_MV		4220
#else /* CONFIG_PM_HIGH_CAPA_BATTERY_TYPE1 */
	#define MAX_VOLTAGE_MV		4200
#endif /* CONFIG_PM_HIGH_CAPA_BATTERY_TYPE1 */
#else  /* CONFIG_BATTERY_SH */
#define MAX_VOLTAGE_MV		4200
#endif /* CONFIG_BATTERY_SH */
