...
#define MIPI_CMD_SHARP_RYOMA_HD_PANEL_NAME  "mipi_cmd_sharp_ryoma_hd"
...
{
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00004 */
#ifdef CONFIG_FB_MSM_MIPI_SHARP_RYOMA_CMD_HD_PT
	if (!strncmp(name, MIPI_CMD_SHARP_RYOMA_HD_PANEL_NAME,
			strnlen(MIPI_CMD_SHARP_RYOMA_HD_PANEL_NAME,
				PANEL_NAME_MAX_LEN)))
		return 0;
#endif /* CONFIG_FB_MSM_MIPI_SHARP_RYOMA_CMD_HD_PT */

#ifdef CONFIG_FB_MSM_MIPI_SHARP_RYOMA_CMD_WXGA_PT
	if (!strncmp(name, MIPI_CMD_SHARP_RYOMA_WXGA_PANEL_NAME,
			strnlen(MIPI_CMD_SHARP_RYOMA_WXGA_PANEL_NAME,
				PANEL_NAME_MAX_LEN)))
		return 0;
#endif /* CONFIG_FB_MSM_MIPI_SHARP_RYOMA_CMD_WXGA_PT */

#ifdef CONFIG_FB_MSM_MIPI_SHARP_KITE_CMD_HD_PT
	if (!strncmp(name, MIPI_CMD_SHARP_KITE_HD_PANEL_NAME,
			strnlen(MIPI_CMD_SHARP_KITE_HD_PANEL_NAME,
				PANEL_NAME_MAX_LEN)))
		return 0;
#endif /* CONFIG_FB_MSM_MIPI_SHARP_KITE_CMD_HD_PT */
