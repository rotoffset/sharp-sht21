...
static struct clk_freq_tbl clk_tbl_sdc[] = {
	...
	F_SDC( 40421052, pll8,  1, 2,  19),
#endif /* CONFIG_MMC_CUST_SH && CONFIG_MMC_MSM_SDC2_SUPPORT */
...
#if defined(CONFIG_S5K3L1YX) || defined(CONFIG_IMX091) || defined(CONFIG_IMX111)
	F_CAM(  6750000, pxo, 4, 0, 0),
#endif /* defined(CONFIG_S5K3L1YX) || defined(CONFIG_IMX091) || defined(CONFIG_IMX111) */

	F_CAM(  8000000, pll8, 4, 1, 12),
	F_CAM( 12000000, pll8, 4, 1,  8),

#if defined(CONFIG_WEBCAM_S5K8AAYX)
	F_CAM( 13500000, pxo, 2, 0, 0),
#endif /* defined(CONFIG_WEBCAM_S5K8AAYX) */
...
static struct clk_lookup msm_clocks_8960[] = {
	...
	CLK_LOOKUP("xo",		cxo_a_clk.c,	NULL),
	CLK_LOOKUP("xo",		pxo_a_clk.c,	NULL),
...
#if defined(CONFIG_MACH_LYNX_DL12) || defined(CONFIG_MACH_LYNX_DL15)
	CLK_LOOKUP("core_clk",		gsbi12_uart_clk.c,	"msm_serial_hsl.2"),
#else
	CLK_LOOKUP("core_clk",		gsbi12_uart_clk.c,	NULL),
#endif	/* CONFIG_MACH_LYNX_DL12 || CONFIG_MACH_LYNX_DL15 */
	...
	CLK_LOOKUP("core_clk",		gsbi4_qup_clk.c,	"qup_i2c.4"),
#if defined(CONFIG_MACH_LYNX_DL15) || defined(CONFIG_MACH_DECKARD_AF33)
	CLK_LOOKUP("core_clk",		gsbi5_qup_clk.c,	NULL),
#else
	CLK_LOOKUP("core_clk",		gsbi5_qup_clk.c,	"spi_qsd.5"),
#endif	/* CONFIG_MACH_LYNX_DL15 || CONFIG_MACH_DECKARD_AF33 */
	...
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-007a"),
#endif /* defined(CONFIG_WEBCAM_S5K8AAYX) */
#if defined(CONFIG_WEBCAM_S5K8AAYX)
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-0078"),
#endif /* defined(CONFIG_WEBCAM_S5K8AAYX) */
#if defined(CONFIG_IMX091)
	CLK_LOOKUP("cam_a_clk",		cam2_clk.c,		NULL),
#endif /* defined(CONFIG_IMX091) */
	CLK_LOOKUP("csi_src_clk",	csi0_src_clk.c,		"msm_csid.0"),
	CLK_LOOKUP("csi_src_clk",	csi1_src_clk.c,		"msm_csid.1"),
#if defined(CONFIG_WEBCAM_OV7692)
...
#endif /* defined(CONFIG_S5K3L1YX) */
#if defined(CONFIG_IMX091)
	CLK_LOOKUP("csi_src_clk",	csi0_src_clk.c,		"4-0034"),
#endif /* defined(CONFIG_IMX091) */
#if defined(CONFIG_WEBCAM_S5K8AAYX)
	CLK_LOOKUP("csi_src_clk",	csi1_src_clk.c,		"4-0078"),
#endif /* defined(CONFIG_WEBCAM_S5K8AAYX) */
...
#endif /* defined(CONFIG_S5K3L1YX) */
#if defined(CONFIG_IMX091)
	CLK_LOOKUP("csi_clk",		csi0_clk.c,		"4-0034"),
#endif /* defined(CONFIG_IMX091) */
#if defined(CONFIG_WEBCAM_S5K8AAYX)
	CLK_LOOKUP("csi_clk",		csi1_clk.c,		"4-0078"),
#endif /* defined(CONFIG_WEBCAM_S5K8AAYX) */
...
#endif /* defined(CONFIG_S5K3L1YX) */
#if defined(CONFIG_IMX091)
	CLK_LOOKUP("csi_phy_clk",	csi0_phy_clk.c,		"4-0034"),
#endif /* defined(CONFIG_IMX091) */
#if defined(CONFIG_WEBCAM_S5K8AAYX)
	CLK_LOOKUP("csi_phy_clk",	csi1_phy_clk.c,		"4-0078"),
#endif /* defined(CONFIG_WEBCAM_S5K8AAYX) */
