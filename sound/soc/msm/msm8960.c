...
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-046*/
/* SP-AMP control     */
#include <sharp/shspamp.h>
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-046*/
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-069*/
#include <sharp/shterm_k.h>
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-069*/
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-115*/
#define TABLA_MBHC_DEF_BUTTONS 1
#else
#define TABLA_MBHC_DEF_BUTTONS 8
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-115*/

#define TABLA_MBHC_DEF_RLOADS 5

#ifdef CONFIG_SH_AUDIO_DRIVER /*02-136*/
#define JACK_DETECT_GPIO 22
#else
#define JACK_DETECT_GPIO 38
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-136*/
...
#ifndef CONFIG_SH_AUDIO_DRIVER /*02-046*/
/* SP-AMP control     */
...
/* SP-AMP control     */
	if (spk & (SHSPAMP_SPK_AMP_POS | SHSPAMP_SPK_AMP_NEG)) {
		...
		if ((msm8960_ext_shspamp_spk_pamp & SHSPAMP_SPK_AMP_POS) &&
			(msm8960_ext_shspamp_spk_pamp & SHSPAMP_SPK_AMP_NEG)) {
		...
		msm8960_ext_shspamp_spk_pamp |= spk;

		if ((msm8960_ext_shspamp_spk_pamp & SHSPAMP_SPK_AMP_POS) &&
			(msm8960_ext_shspamp_spk_pamp & SHSPAMP_SPK_AMP_NEG)) {
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-069*/
				if (msm8960_shspamp_shterm_flg == false) {
					shterm_k_set_info( SHTERM_INFO_SPEAKER, 1 );
					msm8960_shspamp_shterm_flg = true;
				}
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-069*/
...
/* SP-AMP control     */
	if (spk & (SHSPAMP_SPK_AMP_POS | SHSPAMP_SPK_AMP_NEG)) {
		...
		if (!msm8960_ext_shspamp_spk_pamp)
			return;
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-069*/
		if (msm8960_shspamp_shterm_flg == true) {
			shterm_k_set_info( SHTERM_INFO_SPEAKER, 0 );
			msm8960_shspamp_shterm_flg = false;
		}
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-069*/
		shspamp_set_speaker_amp(0);
		msm8960_ext_shspamp_spk_pamp = 0;
#else /* CONFIG_SH_AUDIO_DRIVER */
	if (spk & (BOTTOM_SPK_AMP_POS | BOTTOM_SPK_AMP_NEG)) {
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-046*/
/* SP-AMP control     */
		else if  (!strncmp(w->name, "Ext Spk SHSPAMP Pos", 19))
			msm8960_ext_spk_power_amp_on(SHSPAMP_SPK_AMP_POS);
		else if  (!strncmp(w->name, "Ext Spk SHSPAMP Neg", 19))
			msm8960_ext_spk_power_amp_on(SHSPAMP_SPK_AMP_NEG);
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-046*/
		else {
...
/* SP-AMP control     */
			...
			msm8960_ext_spk_power_amp_off(SHSPAMP_SPK_AMP_POS);
		else if  (!strncmp(w->name, "Ext Spk SHSPAMP Neg", 19))
			msm8960_ext_spk_power_amp_off(SHSPAMP_SPK_AMP_NEG);
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-046*/
		else {
			pr_err("%s() Invalid Speaker Widget = %s\n",
					__func__, w->name);
...
static int msm8960_receiver_event(struct snd_soc_dapm_widget *w,
	struct snd_kcontrol *k, int event)
{
	pr_debug("%s: %x\n", __func__, SND_SOC_DAPM_EVENT_ON(event));
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-046*/
/* SP-AMP control     */
	SND_SOC_DAPM_SPK("Ext Spk SHSPAMP Pos", msm8960_spkramp_event),
	SND_SOC_DAPM_SPK("Ext Spk SHSPAMP Neg", msm8960_spkramp_event),
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-046*/

#ifdef CONFIG_SH_AUDIO_DRIVER /*02-141*/
/* Bone Conduction Receiver control */
#ifdef CONFIG_SHRECEIVER_LM48560
	SND_SOC_DAPM_SPK("Ext Receiver SHRECEIVER", msm8960_receiver_event),
#endif /* CONFIG_SHRECEIVER_LM48560 */
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-141*/
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-046*/
/* SP-AMP control     */
	{"Ext Spk SHSPAMP Pos", NULL, "LINEOUT2"},
	{"Ext Spk SHSPAMP Pos", NULL, "LINEOUT3"},
	{"Ext Spk SHSPAMP Neg", NULL, "LINEOUT4"},
#else  /* CONFIG_SH_AUDIO_DRIVER */
	/* Speaker path */
...
/* Bone Conduction Receiver control */
#ifdef CONFIG_SHRECEIVER_LM48560
	{"Ext Receiver SHRECEIVER", NULL, "EAR"},
#endif /* CONFIG_SHRECEIVER_LM48560 */
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-141*/
...
/* analog handset main mic in amic3 & mic_bias setting */
	{"AMIC3", NULL, "MIC BIAS1 External"},
	{"MIC BIAS1 External", NULL, "Handset Mic"},
/* analog handset sub mic in amic4 & mic_bias setting */
...
#define S(X, Y) ((TABLA_MBHC_CAL_PLUG_TYPE_PTR(tabla_cal)->X) = (Y))
	S(v_no_mic, 30);
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-162*/
#if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 304)
	S(v_hs_max, 2600);
#else
	S(v_hs_max, 2400);
#endif
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-162*/
#undef S
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-158*/
		.pull = PM_GPIO_PULL_UP_30,
#else
		.pull = PM_GPIO_PULL_UP_1P5,
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-158*/
		.function = PM_GPIO_FUNC_NORMAL,
		.vin_sel = 2,
		.inv_int_pol = 0,
	};
...
/*SH_AUDIO_DRIVER->*//*02-042*/
#ifdef CONFIG_SH_AUDIO_DRIVER
int msm8960_headset_hp_state(void)
{
	return hs_jack.status;
}
EXPORT_SYMBOL_GPL(msm8960_headset_hp_state);

int msm8960_headset_bu_state(void)
{
	return button_jack.status;
}
EXPORT_SYMBOL_GPL(msm8960_headset_bu_state);
