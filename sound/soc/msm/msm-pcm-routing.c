...
// SH_AUDIO_DRIVER [+9.0dB for LPA] -->/*02-151*/
#if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 202) || CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 203
#define INT_LPA_RX_VOL_MAX_STEPS 0x6000
#define INT_LPA_RX_VOL_GAIN 0x6000
