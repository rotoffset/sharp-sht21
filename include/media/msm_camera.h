...
#define CFG_SH_SET_FOCUS_AREA 116
#define CFG_SH_SET_FOCUS_CANCEL 117
#define CFG_SH_SET_BESTSHOT_MODE 118

#define SHCAMERA_BESTSHOT_OFF				0
#define SHCAMERA_BESTSHOT_PORTRAIT			1
#define SHCAMERA_BESTSHOT_NIGHT_PORTRAIT	2
#define SHCAMERA_BESTSHOT_LANDSCAPE			3
#define SHCAMERA_BESTSHOT_NIGHT				4
#define SHCAMERA_BESTSHOT_COOKING			5
#define SHCAMERA_BESTSHOT_TEXT				6
#define SHCAMERA_BESTSHOT_SPORTS			7
...
struct sensor_cfg_data {
	...
	union {
		...
		struct focus_area_t focus_area;
		struct sensor_snapshot_info_t sensor_snapshot_info;
		int8_t bestshot_mode;
	} cfg;
};
...
enum focus_mode {
	SHCAM_FOCUS_MODE_NORMAL,
	SHCAM_FOCUS_MODE_MACRO,
	SHCAM_FOCUS_MODE_INFINITY,
	SHCAM_FOCUS_MODE_PRODUCT,
	SHCAM_FOCUS_MODE_CAF
};
...
struct msm_calib_dpc {
	...
	struct pixel_t video60_coord[5];
	struct pixel_t video120_coord[5];
};
